...
export const aboutSection: {
  ...
  {
    question: 'Do you offer repair services for bikes?',
    answer:
      'Yes, we provide repair services for all types of bicycles. Whether you purchased your bike from us or elsewhere, our expert technicians can help with everything from routine maintenance to more complex repairs. Drop by our shop or contact us to schedule a repair.',
  },
];
